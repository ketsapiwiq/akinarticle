...
[![deezer](https://www.arteradio.com/sites/all/themes/artenew/public/static/svg/socials/deezer.svg){.link__logo
...
::: {#main .inner-motion}
::: {.hidden .xiti-infos chapter="Son" page="Fais pas ta beurette" secondary-chapter=""}
:::
...
Fais pas ta beurette {#fais-pas-ta-beurette .cover-episodes__title .u-cover-title .player-title}
====================

[ Un documentaire d\'Ilham Maad ]{.authors__pre}

Petite histoire d\'un fantasme français
...
[]{.btn__icon-container} [13\'07]{.btn__duration .player-duration}
...
Bonne élève et symbole d\'intégration républicaine dans les années 80,
 la \"beurette\" est aujourd\'hui l\'une des insultes les plus prisées
chez les 12-25 ans. En tête des fantasmes sur Youporn, elle est incarnée
par les stars siliconées de la télé-réalité et sa présence fait grimper
l\'audience des plateaux tv. Une image hyper-sexualisée qui n\'est pas
sans rappeler le mythe de la \"femme orientale\" hérité du 19ème siècle.
Comment interpréter cette spectaculaire transformation ? Wissale,
Mounia, Malika et Rakidd livrent sans détour leurs points de vue sur un
fantasme bien français.
:::
:::
...
::: {#recommande .section .selected-podcasts .u-container}
### Vous aimerez aussi {#vous-aimerez-aussi .selected-podcasts__title}

::: {.glide}
::: {.glide__track glide-el="track"}
::: {.glide__slides}
[Inch\'Allah mon amour]{.u-screen-reader-text}
...
Inch\'Allah mon amour {#inchallah-mon-amour .podcast-card__title .player-title}
---------------------

Par [Mehdi Ahoudig [Mehdi
Ahoudig]{.u-screen-reader-text}](/auteurs/mehdi_ahoudig){.no-underline}

Des jeunes femmes françaises et arabes racontent comme elles vivent
l\'amour et ses obstacles : virginité, mariage forcé, pression
familiale, célibat\... Une parole libre\...
:::

[Athées à la menthe (algérienne)]{.u-screen-reader-text}

::: {.podcast-card__image-container}
::: {.podcast-card__buttons}
[]{.btn__icon-container} [14\'20]{.btn__duration .player-duration}
...
::: {.podcast-card__content}
Athées à la menthe (algérienne) {#athées-à-la-menthe-algérienne .podcast-card__title .player-title}
-------------------------------

Par [Marine Vlahovic [Marine
Vlahovic]{.u-screen-reader-text}](/auteurs/marine_vlahovic){.no-underline}

Si l'athéisme a toujours existé dans le monde musulman, il se développe
ces dernières années à la faveur des « printemps arabes » et en réaction
contre\...
:::

[Athées à la menthe (marocaine)]{.u-screen-reader-text}

::: {.podcast-card__image-container}
::: {.podcast-card__buttons}
[]{.btn__icon-container} [13\'32]{.btn__duration .player-duration}
...
::: {.podcast-card__content}
Athées à la menthe (marocaine) {#athées-à-la-menthe-marocaine .podcast-card__title .player-title}
------------------------------

Par [Ilham Maad [Ilham
Maad]{.u-screen-reader-text}](/auteurs/ilham_maad){.no-underline}

Si l'athéisme a toujours existé dans le monde arabo-musulman, il
progresse chez les jeunes ces dernières années en réaction à la montée
de l'intégrisme. Ilham\...
:::
:::
:::
:::
...
-   [![twitter](/sites/all/themes/artenew/public/static/svg/socials/twitter-white.svg){.sharings__link
    .twitter}
    [Twitter]{.u-screen-reader-text}](/son/61657962/fais_pas_ta_beurette){.btn--twitter}
-   [![facebook](/sites/all/themes/artenew/public/static/svg/socials/facebook-white.svg){.sharings__link
    .facebook}
    [Facebook]{.u-screen-reader-text}](/son/61657962/fais_pas_ta_beurette){.btn--facebook}
-   [![email](/sites/all/themes/artenew/public/static/svg/socials/mail-white.svg){.sharings__link
    .email}
    [E-mail]{.u-screen-reader-text}](/son/61657962/fais_pas_ta_beurette){.btn--mail}
